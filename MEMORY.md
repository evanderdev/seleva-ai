...
- Feedback local (2026-09-10): `cleanup_feedback` registra recommendation/decision por asset para futuros sinais de ranking; a confirmação de lixeira grava `trash/trashed` antes de remover o índice. Não inclui prompt, OCR ou conteúdo visual.
