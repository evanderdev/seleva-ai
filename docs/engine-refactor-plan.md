...
- A persistência mantém o payload agregado para as consultas existentes e grava `photo_analysis_capabilities` com estado, versão, modelo e erro por capability. A extração de sinais para tabelas específicas permanece planejada.
