...
export const ptBR: Messages = {
  ...
  calmLibrary: 'Uma vis?o tranquila da sua galeria',
  privateFooter: 'Seus arquivos ficam privados e sob seu controle.',
  smartSelection: 'Sele??o inteligente',
  foundTitle: 'Encontramos itens para voc?',
  foundDescription:
  ...
  itemsOnPage: '{{count}} itens nesta p?gina',
  selectionCount: '{{count}} selecionados',
  selectAll: 'Selecionar p?gina',
  clearSelection: 'Limpar sele??o',
  reviewSelection: 'Revisar sele??o',
  personalize: 'Personalize o SelevaAI',
  personalizeHint: 'Escolha como o app deve aparecer para voc?.',
  autoSaved: 'Suas prefer?ncias s?o salvas automaticamente.',
  back: 'Voltar',
...
export const es: Messages = {
  ...
  calmLibrary: 'Una vista tranquila de tu galer?a',
  privateFooter: 'Tus archivos son privados y est?n bajo tu control.',
  smartSelection: 'Selecci?n inteligente',
  foundTitle: 'Encontramos elementos para ti',
  foundDescription: 'Revisa los elementos y ajusta el filtro cuando quieras.',
  editFilter: 'Editar filtro',
  adjustSearch: 'Ajusta tu b?squeda',
  updateResults: 'Actualizar resultados',
  itemsOnPage: '{{count}} elementos en esta p?gina',
  selectionCount: '{{count}} seleccionados',
  selectAll: 'Seleccionar p?gina',
  clearSelection: 'Borrar selecci?n',
  reviewSelection: 'Revisar selecci?n',
  personalize: 'Personaliza SelevaAI',
  personalizeHint: 'Elige c?mo se muestra la app para ti.',
  autoSaved: 'Tus preferencias se guardan autom?ticamente.',
  back: 'Volver',
  removeFilter: 'Quitar filtro',
  invalidPrompt: 'Escribe una b?squeda de 1 a 500 caracteres.',
  manageLibrary: 'Administrar biblioteca',
  confirmMoveToTrashTitle: 'Â¿Mover a la papelera?',
  confirmMoveToTrashMessage:
    'Â¿Mover {{count}} elementos seleccionados a la papelera del dispositivo?',
  cancel: 'Cancelar',
