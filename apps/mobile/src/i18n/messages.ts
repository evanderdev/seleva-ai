...
export const en = {
  ...
  savedSelectionItems: '{{count}} items',
  deleteSavedSelection: 'Delete saved selection',
  deleteSavedSelectionTitle: 'Delete saved selection?',
  deleteSavedSelectionMessage: 'Delete “{{name}}”? Your photos and videos will be kept.',
...
export const ptBR: Messages = {
  ...
  savedSelectionItems: '{{count}} itens',
  deleteSavedSelection: 'Excluir seleção salva',
  deleteSavedSelectionTitle: 'Excluir seleção salva?',
  deleteSavedSelectionMessage: 'Excluir “{{name}}”? Suas fotos e vídeos serão mantidos.',
  selectionName: 'Nome da seleção',
  save: 'Salvar',
...
export const es: Messages = {
  ...
  savedSelectionItems: '{{count}} elementos',
  deleteSavedSelection: 'Eliminar selección guardada',
  deleteSavedSelectionTitle: '¿Eliminar selección guardada?',
  deleteSavedSelectionMessage: '¿Eliminar “{{name}}”? Tus fotos y vídeos se conservarán.',
  selectionName: 'Nombre de la selección',
  save: 'Guardar',
